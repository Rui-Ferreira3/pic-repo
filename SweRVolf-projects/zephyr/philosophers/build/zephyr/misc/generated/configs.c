...
GEN_ABSOLUTE_SYM(CONFIG_GPIO_SWERVOLF, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_SWERV_PIC, 1);
GEN_ABSOLUTE_SYM(CONFIG_NUM_IRQS, 64);
GEN_ABSOLUTE_SYM(CONFIG_UART_NS16550, 1);
GEN_ABSOLUTE_SYM(CONFIG_UART_NS16550_PORT_0, 1);
GEN_ABSOLUTE_SYM(CONFIG_GPIO_MMIO32, 1);
GEN_ABSOLUTE_SYM(CONFIG_RISCV_MACHINE_TIMER, 1);
GEN_ABSOLUTE_SYM(CONFIG_RISCV_ROM_BASE_ADDR, 0x00000000);
GEN_ABSOLUTE_SYM(CONFIG_RISCV_ROM_SIZE, 0x0);
GEN_ABSOLUTE_SYM(CONFIG_RISCV_GENERIC_TOOLCHAIN, 1);
GEN_ABSOLUTE_SYM(CONFIG_BOARD_SWERVOLF_NEXYS, 1);
GEN_ABSOLUTE_SYM(CONFIG_SOC_RISCV32_SWERVOLF, 1);
GEN_ABSOLUTE_SYM(CONFIG_ARCH, 1);
GEN_ABSOLUTE_SYM(CONFIG_GEN_ISR_TABLES, 1);
GEN_ABSOLUTE_SYM(CONFIG_RISCV, 1);
GEN_ABSOLUTE_SYM(CONFIG_ARCH_IS_SET, 1);
GEN_ABSOLUTE_SYM(CONFIG_SRAM_SIZE, 8192);
...
GEN_ABSOLUTE_SYM(CONFIG_NUM_COOP_PRIORITIES, 29);
GEN_ABSOLUTE_SYM(CONFIG_NUM_PREEMPT_PRIORITIES, 40);
...
GEN_ABSOLUTE_SYM(CONFIG_TOOLCHAIN_ZEPHYR_0_12, 1);
